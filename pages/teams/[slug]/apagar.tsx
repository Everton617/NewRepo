...
export default function DeliveryDriversTable(): React.ReactElement {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (formData.documents.id) formDataToSend.append('id', formData.documents.id)
      if (formData.documents.proofOfResidence) formDataToSend.append('proofOfResidence', formData.documents.proofOfResidence)
      if (formData.documents.vehicleDocument) formDataToSend.append('vehicleDocument', formData.documents.vehicleDocument)
