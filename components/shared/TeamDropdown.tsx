...
const TeamDropdown = () => {
  ...
  return (
    <div className="dropdown w-full">
      <div
        tabIndex={0}
        className=" dark:border-gray-600 flex h-10 items-center px-4 justify-between cursor-pointer rounded text-sm font-bold"
        style={{ border: "2px solid #bab0b066" }}>
        {currentTeam?.name ||
